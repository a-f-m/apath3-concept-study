//=========================================================================
//
//  This file was generated by Mouse 1.8 at 2018-05-10 09:58:55 GMT
//  from grammar
//    'E:\ISST-2009\Development\Eclipse-ng-sem\Eclipse-private\Apath3\src\m
//    ain\java\hidden\parserV3.peg'.
//
//=========================================================================
...
public class PathPegParserV3 extends mouse.runtime.ParserBase
{
  ...
  //=====================================================================
  //  ifExpr = (boolOrExpr ("->" __ expr ("~" __ expr)?)? / "if" NLOD __
  //    boolOrExpr "then" NLOD __ expr ("else" NLOD __ expr)?) {TL} ;
  //=====================================================================
  ...
  //-------------------------------------------------------------------
  //  ifExpr_0 = boolOrExpr ("->" __ expr ("~" __ expr)?)?
  //-------------------------------------------------------------------
  ...
  //-------------------------------------------------------------------
  //  ifExpr_1 = "if" NLOD __ boolOrExpr "then" NLOD __ expr ("else"
  //    NLOD __ expr)?
  //-------------------------------------------------------------------
  ...
  //-------------------------------------------------------------------
  //  ifExpr_2 = "->" __ expr ("~" __ expr)?
  //-------------------------------------------------------------------
  public boolean ifExpr_2()
    {
      begin("");
      if (!next("->")) return rejectInner();
      __();
  ...
  //-------------------------------------------------------------------
  //  ifExpr_3 = "else" NLOD __ expr
  //-------------------------------------------------------------------
  public boolean ifExpr_3()
    {
      begin("");
  ...
  //=====================================================================
  //  step = selection nodeBinding? filter? {T} ;
  //=====================================================================
  public boolean step()
    {
      begin("step");
  ...
  //    "this" / "if" / "then" / "else") !LetterOrDigit ;
  //=====================================================================
